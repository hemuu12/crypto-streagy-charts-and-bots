...
import { generateRsiSignals } from "./strategy-rsi.js";
...
function snapshot(c) {
  return {
    ...
    chande: round(c.chande, 2),
  };
}

export async function runRsiBacktest(symbol, start, end) {
  ...
  const evaluated = generateRsiSignals(raw1h, raw4h, {
