...
import { PULLBACK_TIMEFRAME, INITIAL_CAPITAL, STOP_LOSS_PCT, TAKE_PROFIT_PCT, RISK_PER_TRADE } from "./config.js";
...
export async function runPullbackBacktest(symbol, start, end) {
